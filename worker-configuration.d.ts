/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 02b7e70f6ef70a998eaa43a699793f4c)
...
interface __BaseEnv_Env {
	...
	MOCK_VOICE: string;
	Apollo: DurableObjectNamespace<import("./src/index").Apollo>;
	Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
	BACKGROUND: Workflow<Parameters<import("./src/index").ApolloBackground['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Apollo" | "Sandbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENROUTER_MODEL" | "OPENROUTER_STT_MODEL" | "OPENROUTER_RESEARCH_MODEL" | "ELEVENLABS_TTS_MODEL" | "OPENROUTER_EMBEDDING_MODEL" | "APOLLO_OWNER_EMAIL" | "DEVICE_SHARED_SECRET" | "OPENROUTER_API_KEY" | "ELEVENLABS_API_KEY" | "TAVILY_API_KEY" | "RESEND_API_KEY" | "MOCK_VOICE">> {}
}
